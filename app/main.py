...
class MIDIKeyboardApp(ctk.CTk):
    ...
    def create_ui(self):
        ...
        self.status_frame = ctk.CTkFrame(self.main_frame, fg_color=DARK_BG, height=30)
        ...
        self.left_section = ctk.CTkFrame(self.keyboard_frame, fg_color=DARK_BG, width=150)
        ...
        # SLIDER SECTION
        self.slider_frame = ctk.CTkFrame(self.keyboard_frame, fg_color=DARK_BG, width=70)
